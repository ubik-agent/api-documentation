...
<CardGroup cols={2}>
  ...
  <Card title="Compétences (Skills)" icon="lightbulb" href="#competences-skills">
...
<Info>Vous pouvez gérer vos compétences à l'aide des points de terminaison [`/skills`](/fr/api-reference/public-api/lister-les-competences).</Info>
