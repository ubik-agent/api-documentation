...
<Step title="Lancer une Exécution d'Outil">
  Tout d'abord, exécutez un outil comme vous le feriez normalement. La réponse initiale `202 Accepted` contiendra une `stream_url`. C'est le point de terminaison que nous utiliserons pour recevoir les événements en direct.
