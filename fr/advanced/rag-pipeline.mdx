...
*   **Personnalisation :**
    ...
    *   **Optimisé :** Vous pouvez déployer notre modèle OCR propriétaire et optimisé dans votre propre section admin pour des besoins de performance et de confidentialité accrus. *Consultez notre guide sur le [Parseur GPU Auto-hébergé](/fr/guides/self-hosted-gpu-parser) pour apprendre comment mettre en place une instance personnalisée.*
