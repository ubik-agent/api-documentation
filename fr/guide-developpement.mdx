...
<Info>Vous pouvez gérer vos espaces de travail via les points de terminaison [`/workspaces`](/fr/api-reference/introduction#tag/Public-API-Workspaces).</Info>
...
Vous pouvez découvrir et exécuter des outils à l'aide des points de terminaison [`/tools`](/fr/api-reference/introduction#tag/Public-API-Tools).
