...
*   **Workspaces**, **Agent Sessions**, and **Tool Executions** created with a specific `external_user_id` are strictly private. They can only be accessed by that same user ID.
*   User A cannot see User B's workspaces, chat history, or tool results.
