...
<Info>You can manage your workspaces through the [`/workspaces`](/en/api-reference/introduction#tag/Public-API-Workspaces) endpoints.</Info>
...
You can discover and execute tools using the [`/tools`](/en/api-reference/introduction#tag/Public-API-Tools) endpoints.
